...
| term:usermsghighlight                | bool     | highlight your own messages in an agent session (default true)                                                                                                                                                                                                |
| term:usermsgbg                       | string   | background color of your own messages, any CSS color (default a translucent blue)                                                                                                                                                                             |
| term:usermsgcolor                    | string   | text color of your own messages, any CSS color (default: leave the original colors)                                                                                                                                                                           |
